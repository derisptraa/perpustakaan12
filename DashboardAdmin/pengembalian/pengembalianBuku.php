...
$dataPeminjam = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, kategori_buku.nama_kategori AS kategori, pengembalian.nisn, member.nama, member.angkatan, member.jurusan, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
INNER JOIN buku ON pengembalian.id_buku = buku.id_buku
INNER JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
    ...
    <table class="table table-striped table-hover">
     <thead class="text-center">
      <tr>
        ...
        <th class="bg-primary text-light">Angkatan</th>
