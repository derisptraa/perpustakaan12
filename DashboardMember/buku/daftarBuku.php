...
$buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori 
FROM buku 
...
if(isset($_POST["informatika"]) ) {
  $buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori FROM buku 
  JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
  WHERE kategori_buku.nama_kategori = 'informatika'");
}
//read buku bisnis
if(isset($_POST["bisnis"]) ) {
  $buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori FROM buku 
  JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
  WHERE kategori_buku.nama_kategori = 'bisnis'");
}
//read buku filsafat
if(isset($_POST["filsafat"]) ) {
  $buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori FROM buku 
  JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
  WHERE kategori_buku.nama_kategori = 'filsafat'");
...
if(isset($_POST["novel"]) ) {
  $buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori FROM buku 
  JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
  WHERE kategori_buku.nama_kategori = 'novel'");
...
if(isset($_POST["sains"]) ) {
  $buku = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori FROM buku 
  JOIN kategori_buku ON buku.id_kategori = kategori_buku.id_kategori
  WHERE kategori_buku.nama_kategori = 'sains'");
}
?>
  ...
  <body>
    ...
    <div class="layout-card-custom">
     ...
     <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Deri Saputra</span> © 2025</p>
