...
if (!isset($_SESSION["signIn"]) || !isset($_SESSION["member"]["nama"])) {
  // Jika sesi tidak ada, arahkan ke halaman sign-in member
...
<style>
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard IniPerpus</div>
