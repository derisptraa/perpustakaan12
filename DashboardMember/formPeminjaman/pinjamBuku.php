...
$idBuku = $_GET["id"];
$query = queryReadData("SELECT buku.*, kategori_buku.nama_kategori AS kategori 
                        FROM buku 
...
if (isset($_POST["pinjam"])) {
  ...
  if ($result > 0) {
      ...
      window.location.href = '../buku/daftarBuku.php';
      </script>";
  } elseif ($result === 0) {
      echo "<script>
      alert('Buku sudah dipinjam atau ada masalah dalam proses peminjaman.');
      </script>";
  } else {
      echo "<script>
      alert('Terjadi kesalahan. Buku gagal dipinjam.');
      </script>";
  }
}
      ...
      <div class="card-body d-flex flex-wrap gap-4 justify-content-center">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="kelas" aria-label="kelas" aria-describedby="basic-addon1" value="<?= $item["angkatan"]; ?>" readonly>
            </div>
          <div class="input-group mb-3">
